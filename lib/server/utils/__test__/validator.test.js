  ...
  describe('validator', () => {
    describe('Users Signup', () => {
      ...
      it('should throw error with status code 400 for invalid email', async () => {
        ...
        await expect(isValid).rejects.toHaveProperty('code');
        await expect(isValid).rejects.toHaveProperty('message');

        await expect(isValid).rejects.toMatchObject({ code: 400 });
      });
